        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className={`relative ${article.featured_image ? '-mt-32' : 'pt-10'}`}>
                <article className="max-w-4xl mx-auto bg-white rounded-xl shadow-xl overflow-hidden">
                    ...
                    {/* article content */}
                    <div className="px-6 md:px-12 pb-10 w-full">

                        {/* Xalkan wuxuu qasbayaa in tags-ka ku dhex jira article.content aysan jarin erayada */}
                        <style>{`
                        ...
                        <div
                            className="prose prose-lg prose-rose max-w-none w-full text-justify custom-article-formatting"
